...
Graph connectivity
    Physics owns the wall-aware graph and stores the final per-drone
    connectivity flags. Observations consume those flags directly so actor
    inputs, communication, rewards, and rendering describe the same graph.
...
from swarmecho.core.config import compute_obs_dim
from swarmecho.env.raycast import dda_dist
...
if __name__ == "__main__":
    from swarmecho.core.config import compute_obs_dim, load_config, validate_config
