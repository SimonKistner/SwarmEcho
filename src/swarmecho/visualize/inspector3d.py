...
function sceneAxes(){let size=worldSize(),fixed=$('fixedBounds')?.checked,axis=(title,maximum)=>fixed?{title,gridcolor:'#22304a',range:[0,maximum],autorange:false}:{title,gridcolor:'#22304a',autorange:true};return {xaxis:axis('X',size[0]),yaxis:axis('Y',size[1]),zaxis:axis('Z',size[2])}}
