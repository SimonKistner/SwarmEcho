...
function fixedAxes(){let size=worldSize(),axis=(title,maximum)=>({title,gridcolor:'#22304a',range:[0,maximum],autorange:false});return {xaxis:axis('X',size[0]),yaxis:axis('Y',size[1]),zaxis:axis('Z',size[2])}}
function sceneLayout(revision){return {bgcolor:'#090e18',uirevision:revision,aspectmode:'data',...fixedAxes(),camera:camera||DEFAULT_CAMERA}}
