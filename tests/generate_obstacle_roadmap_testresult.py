...
def generate(destination=None, *, level_name=None, map_name=None, target=None,
             ...
             merge_walls=None, corner_bonus_m=None):
    ...
    if cfg.roadmap_merge_walls:
        authored_vertices = authored_roadmap_vertices(
            building.solid_min_m, building.solid_max_m, bounds_lower, bounds_upper,
            clearance, building.cell_size_m)
    for index in range(count):
        ...
        if not cfg.roadmap_merge_walls:
