...
- [2D removal audit](03_roadmap/05_2d_removal_audit.md)
...
Historical documents preserve context and are not operational instructions.
Current code, selected level YAML, and current guides take precedence.
